...
if [[ "${@}" == *"1"* ]] ; then
    sleep 0.2
    # python3 -u ${client_path} localhost 20000  110  localhost 20110 &
...
if [[ "${@}" == *"2"* ]] ; then
    sleep 0.2
    # python3 -u ${client_path} localhost 20000  120  localhost 20120 &
...
if [[ "${@}" == *"3"* ]] ; then
    sleep 0.2
    # python3 -u ${client_path} localhost 20110  210  localhost 20210 &
