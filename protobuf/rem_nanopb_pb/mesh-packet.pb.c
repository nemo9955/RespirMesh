...
const pb_field_t RespirMeshLog_fields[5] = {
    PB_FIELD(  1, UINT32  , SINGULAR, STATIC  , FIRST, RespirMeshLog, source_timestamp, source_timestamp, 0),
    PB_FIELD(  2, UINT32  , SINGULAR, STATIC  , OTHER, RespirMeshLog, source_id, source_timestamp, 0),
    PB_FIELD(  4, UENUM   , SINGULAR, STATIC  , OTHER, RespirMeshLog, severity, source_id, 0),
    PB_FIELD(  6, STRING  , SINGULAR, STATIC  , OTHER, RespirMeshLog, message, severity, 0),
    PB_LAST_FIELD
};
